...
#define RPL_LIST(client, channel, userCount, topic) (SERVERNAME + " 322 " + client + " " + channel + " " + intToString(userCount) + " :" + topic + "\r\n")
#define RPL_LISTEND(client) (SERVERNAME + " 323 " + client + " :End of /LIST\r\n")
#define RPL_NAMREPLY(client, symbol, channel, userlist) (SERVERNAME + " 353 " + client + " " + symbol + " " + channel + " :" + userlist + "\r\n")
...
// #define MODE_OP(channel, client) (SERVERNAME + " MODE " + channel + " +o " + client + "\r\n")
